    ...
    <main className="min-h-screen bg-[var(--background)]">
      ...
      <section className="relative overflow-hidden py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-3xl mx-auto flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="h1 text-3xl md:text-4xl font-extrabold mb-1">AI Video Maker</h1>
            <p className="text-lg text-[var(--text-muted)]">Turn scripts into videos in minutes</p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            <div className="card-premium">
              <h2 className="text-xl font-bold mb-6 text-[var(--accent-3)]">Video Settings</h2>
              {/* Script Input */}
              <div className="mb-6">
                <label className="block text-[var(--accent-3)] font-semibold mb-3">Script</label>
                <textarea
                  value={script}
          ...
          <div className="space-y-6">
            <div className="card-premium">
              <h2 className="text-xl font-bold mb-6 text-[var(--accent-3)]">Generated Video</h2>
              {videoUrl ? (
            ...
            <div className="card-premium">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="p-4 bg-[var(--glass)] rounded-lg">
                  ...
                  <p className="text-sm text-[var(--text-muted)]">Create product promo videos</p>
                </div>
                <div className="p-4 bg-[var(--glass)] rounded-lg">
                  <h4 className="font-semibold text-[var(--accent-3)] mb-2">Social Media</h4>
                  <p className="text-sm text-[var(--text-muted)]">Generate engaging video content</p>
                </div>
                <div className="p-4 bg-[var(--glass)] rounded-lg">
                  <h4 className="font-semibold text-[var(--accent-3)] mb-2">Education</h4>
                  <p className="text-sm text-[var(--text-muted)]">Produce explainer videos</p>
                </div>
              </div>
            </div>
          </div>
