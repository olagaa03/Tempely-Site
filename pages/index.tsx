...
export default function HomePage() {
  return (
    <>
      {/* 🟢 Logged-out experience (Public Homepage) */}
      <SignedOut>
            ...
            <div className="md:w-1/2 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <a href="/hooked">
                <img
                  ...
                  className="rounded-xl w-full shadow-md hover:opacity-90 transition-transform duration-300 hover:scale-105"
                />
              </a>
              <a href="/posted">
                <img
      ...
      <SignedIn>
        <main className="min-h-screen bg-gradient-to-b from-white to-gray-100 text-center font-sans px-6 py-24">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Welcome back to Tempely 👋
          </h1>
          <p className="text-lg md:text-xl text-gray-800 mb-6 max-w-2xl mx-auto">
            Your dashboard is ready. Start generating viral content, tracking results, and unlocking Pro features.
          </p>
          <a
            href="/ai-tool"
            className="inline-block bg-green-600 text-white px-6 py-3 rounded-xl font-semibold text-lg shadow hover:opacity-90 transition"
          >
            Go to AI Tool
          </a>
        </main>
