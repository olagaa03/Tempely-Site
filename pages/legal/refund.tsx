    ...
    <main className="min-h-screen bg-gradient-to-br from-[#0F0F1C] via-[#18122B] to-[#4B2067] flex flex-col justify-between">
      ...
      <section className="flex flex-col items-center justify-center py-20 px-6 w-full max-w-3xl mx-auto animate-fade-in">
        <div className="card-premium flex flex-col gap-6 items-center w-full animate-fade-in delay-100">
          <h1 className="h1 text-3xl md:text-4xl font-extrabold gradient-text mb-4">Refund Policy</h1>
          <p className="text-white/80 text-lg mb-4">We want you to love Tempely. If you’re not satisfied, here’s how refunds work.</p>
          {/* Insert actual refund policy content here, using <h2> and <p> for sections */}
          <h2 className="h2 text-xl font-bold gradient-text mb-2 mt-4">Eligibility</h2>
          ...
          <h2 className="h2 text-xl font-bold gradient-text mb-2 mt-4">How to Request</h2>
          ...
          <h2 className="h2 text-xl font-bold gradient-text mb-2 mt-4">Processing</h2>
