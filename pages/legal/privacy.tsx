export default function Privacy() {
    return (
      <main className="max-w-3xl mx-auto py-12 px-6">
        ...
        <p className="mb-4">Tempely Gaarden respects your privacy. Here’s how we handle your data:</p>
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>Payments are handled by third parties like Lemon Squeezy.</li>
          <li>Contact: hello@tempely.com</li>
        </ul>
      </main>
    );
  }
